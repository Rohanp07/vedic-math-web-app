  ...
  return (
    <div>
      <div className="sutras">
        <h2 className="head sHead" style={{textAlign:'center'}}>SUTRAS</h2>
        <Table id="table1" bordered responsive>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Multiplication of numbers, which are near to base like 10, 100,
                1000
              </td>
            </tr>
            <tr>
              ...
              <td>
                It is the general formula, applicable to all cases of
            ...
            <tr>
              ...
              <td>
                To find out the product of two number when both are near the
                common base like 40, 40, etc. (multiples of powers of 10).
              </td>
            </tr>
            <tr>
              <td>7</td>
              ...
              <td>
                It is used to solve simultaneous simple equations which have the
                co-efficient of the variables interchanged.
              </td>
            </tr>
            <tr>
              <td>8</td>
            ...
            <tr>
              ...
              <td>
                Applicable to obtain sq. of a number close to bases of powers of
                10
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                It is to express a fraction as a decimal to all its decimal
                places
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                Used to verify the correctness of obtained answers in
                multiplications, divisions and factorizations.
              </td>
            </tr>
            <tr>
              <td>16</td>
        ...
        <div className="sub-sutras" style={{textAlign:'center'}}>
          ...
          <Table id="table1" bordered responsive>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Whatever the Deficiency lessen by that amount and set up the
                  Square of the Deficiency
                </td>
              </tr>
              <tr>
                <td>8</td>
